...
export class ContentOptimizer {
  private logger = new Logger('ContentOptimizer');

  async optimizeForPlatform(content: Content, platform: SocialPlatform): Promise<Content> {
    try {
  ...
  private getPlatformSpecs(platform: SocialPlatform) {
    const specs = {
  ...
  private optimizeHashtags(hashtags: string[], platform: SocialPlatform): string[] {
